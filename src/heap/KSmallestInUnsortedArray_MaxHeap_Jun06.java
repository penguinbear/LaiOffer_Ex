 ...
 */
public class KSmallestInUnsortedArray_MaxHeap_Jun06 {
    public static void main(String[] a) {
        ...
        KSmallestInUnsortedArray_MaxHeap_Jun06 kSmallest = new KSmallestInUnsortedArray_MaxHeap_Jun06();
    ...
    public int[] kSmallest(int[] array, int k) {
        ...
        PriorityQueue<Integer> kHeap = new PriorityQueue<Integer>(k, Collections.reverseOrder());
        int i;
        for (i = 0; i < k ; i++) {
            kHeap.offer(array[i]);
        }
